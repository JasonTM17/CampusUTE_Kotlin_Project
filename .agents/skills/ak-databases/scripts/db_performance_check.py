...
class PerformanceAnalyzer:
    ...
    def _analyze_mongodb(self) -> PerformanceReport:
        ...
        for coll_name in self.db.list_collection_names():
            ...
            # PyMongo returns a command cursor, while lightweight test and
            # adapter doubles commonly return a list/iterable.
            if hasattr(stats_cursor, "next"):
                stats = stats_cursor.next()
            else:
                stats = next(iter(stats_cursor), {})
