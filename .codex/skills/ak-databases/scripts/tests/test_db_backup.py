...
class TestBackupManager:
    ...
    def test_backup_postgres(self, mock_run, temp_backup_dir):
        ...
        # Let the real file handle create the dump target so the implementation
        # can stat it after the mocked pg_dump completes. Mocking ``open`` here
        # prevented the file from existing and masked a valid backup path.
        backup_info = manager.create_backup(
